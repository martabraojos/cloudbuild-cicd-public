...
def main(big_query_client=client):
    #return "Hello World!"
    table_id = "king-dap-learning-sandbox.test_schema_marta.us_states"
    job_config = bigquery.LoadJobConfig(
        write_disposition=bigquery.WriteDisposition.WRITE_TRUNCATE,
        source_format=bigquery.SourceFormat.CSV,
        skip_leading_rows=1,
    )
    uri = "gs://sidd-ml-ops-marta/us-states.csv"
    ...
    return jsonify({"num_rows": destination_table.num_rows})
